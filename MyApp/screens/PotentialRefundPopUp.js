...
import CoinIcon from './assets/images/pagePotentialRefundPopUp/CoinIcon.svg';
...
const PotentialRefunPopUp = () => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.overlapWhite}>
        <CoinIcon style={{bottom:width*0.2}}/>
        <Text style={styles.found}>We've Found</Text>
        <Text style={styles.fiveHundred}>$500</Text>
        <Text style={styles.PotentialRefund}>Potential refunds from 43 items</Text>
      </View>
      ...
      <TouchableOpacity style={styles.button}> 
        <View style={styles.rowDisplay}> 
          ...
          <Text style={styles.buttonText}>Start Exploaring</Text>
        </View> 
      </TouchableOpacity>
...
export default PotentialRefunPopUp;